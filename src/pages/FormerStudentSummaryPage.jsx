...
function FormerStudentSummaryPage() {
  ...
  const getPurposeDisplay = () => {
    if (formData.purpose === 'Others' && formData.otherPurpose) {
      return `Others: ${formData.otherPurpose}`
    }
    return formData.purpose || 'Not provided'
  }
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="border-4 rounded-2xl p-8 mb-12" style={{borderColor: '#111c4e', backgroundColor: '#f9f9f9'}}>
            ...
            <div className="mb-4">
              ...
              <span className="text-lg" style={{color: '#111c4e'}}>{getPurposeDisplay()}</span>
            </div>
            ...
            <div className="mb-4">
              <span className="font-bold text-lg" style={{color: '#111c4e'}}>LAST LEVEL & YEAR ATTENDED: </span>
              <span className="text-lg" style={{color: '#111c4e'}}>{formData.lastLevelYear || 'Not provided'}</span>
            </div>

            {/* REQUIREMENT/S */}
            <div className="mb-4">
              <span className="font-bold text-lg" style={{color: '#111c4e'}}>REQUIREMENT/S: </span>
              <span className="text-lg" style={{color: '#111c4e'}}>C.O.R/Form 138/T.O.R (Uploaded)</span>
            </div>
          ...
          <div className="flex justify-center gap-6">
            <button
              ...
              onClick={() => navigate('/former-student-info', { state: { formData, requesterData } })}
            >
              BACK
            </button>
            <button
...
export default FormerStudentSummaryPage
