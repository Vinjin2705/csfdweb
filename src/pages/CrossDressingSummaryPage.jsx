...
function CrossDressingSummaryPage() {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="border-4 rounded-2xl p-6 mb-8" style={{borderColor: '#111c4e', backgroundColor: '#f9f9f9'}}>
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <span style={{color: '#111c4e'}}>{formData.contactNumber || 'Not provided'}</span>
              </div>
          ...
          <div className="flex justify-center gap-4">
            <button
              ...
              onClick={() => navigate('/cross-dressing-form', { state: { formData } })}
            >
              BACK
            </button>
            <button
...
export default CrossDressingSummaryPage
