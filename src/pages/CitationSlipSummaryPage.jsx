...
function CitationSlipSummaryPage() {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="border-4 rounded-2xl p-6 mb-8" style={{borderColor: '#111c4e', backgroundColor: '#f9f9f9'}}>
            ...
            <div className="space-y-3">
              ...
              {/* STUDENT NUMBER */}
              <div>
                <span className="font-bold" style={{color: '#111c4e'}}>STUDENT NUMBER: </span>
                <span style={{color: '#111c4e'}}>{formData.studentNumber || 'Not provided'}</span>
              </div>

              {/* COLLEGE */}
              <div>
                <span className="font-bold" style={{color: '#111c4e'}}>COLLEGE: </span>
                <span style={{color: '#111c4e'}}>{formData.college || 'Not provided'}</span>
              </div>

              {/* YEAR LEVEL */}
              <div>
                <span className="font-bold" style={{color: '#111c4e'}}>YEAR LEVEL: </span>
          ...
          <div className="flex justify-center gap-4">
            <button
              ...
              onClick={() => navigate('/citation-slip-form', { state: { formData } })}
            >
              BACK
            </button>
            <button
...
export default CitationSlipSummaryPage
