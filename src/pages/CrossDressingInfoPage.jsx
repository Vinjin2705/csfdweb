...
function CrossDressingInfoPage() {
  ...
  const steps = [
    {
      number: 1,
      title: 'Accomplish this Request Form.',
      description: ''
    },
    {
      number: 2,
      title: 'Wait for the validation of your request. Once validated, an email will be sent through your email for certification.',
      description: ''
    },
    {
      number: 3,
      title: "Print the emailed certificate. Ask for the signature of CGCS Director and your College/Institute's Dean",
      description: ''
    },
    {
      number: 4,
      title: 'Proceed to the Center for Student Formation and Discipline (CSFD) to have your request certified with the official University seal.',
      description: ''
    }
  ]
      ...
      <section className="px-12 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-10">
            <h1 className="text-3xl font-black" style={{color: '#3d3d3d', fontFamily: 'Metropolis, sans-serif', fontWeight: '900'}}>CROSS-DRESSING REQUEST</h1>
            <h2 className="text-2xl font-black" style={{color: '#ffc400', fontFamily: 'Metropolis, sans-serif', fontWeight: '900'}}>FORM</h2>
          </div>
              ...
              {steps.map((step, index) => (
                <div key={index} className="flex gap-6 relative items-center">
                  ...
                  <div className="bg-white rounded-xl shadow-lg p-6 flex-1">
                    <h3 className="text-xl font-bold mb-2" style={{color: '#111c4e'}}>Step {step.number}</h3>
          ...
          <div className="flex justify-center gap-4 mt-12">
            ...
            <button
              ...
              onClick={() => navigate('/cross-dressing-form')}
            >
              PROCEED
            </button>
          </div>
...
export default CrossDressingInfoPage
