...
function OtherExemptionSummaryPage() {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="border-4 rounded-2xl p-6 mb-8" style={{borderColor: '#111c4e', backgroundColor: '#f9f9f9'}}>
            ...
            <div className="space-y-3">
              ...
              {/* NATURE OF REQUEST */}
              <div>
                <span className="font-bold" style={{color: '#111c4e'}}>NATURE OF REQUEST: </span>
                <span style={{color: '#111c4e'}}>{formData.natureOfRequest || 'Not provided'}</span>
              </div>
              ...
              <div>
                ...
                <div className="ml-4 mt-1 space-y-1">
                  ...
                  <p style={{color: '#111c4e'}}>{formData.supportingDocFile ? `✓ ${formData.supportingDocFile.name}` : '<<requirements>>'}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-center gap-4">
            <button
              ...
              onClick={() => navigate('/other-exemption-form', { state: { formData } })}
            >
              BACK
            </button>
            <button
...
export default OtherExemptionSummaryPage
