      ...
      <section className="px-12 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="border-4 rounded-2xl p-8 mb-12" style={{borderColor: '#111c4e', backgroundColor: '#f9f9f9'}}>
            ...
            {/* YEAR GRADUATED and STUDENT NUMBER */}
            <div className="mb-4 flex justify-between items-start">
              <div className="flex-1">
                <span className="font-bold text-lg" style={{color: '#111c4e'}}>YEAR GRADUATED: </span>
                <span className="text-lg" style={{color: '#111c4e'}}>{formData.yearGraduated || 'Not provided'}</span>
              </div>
              <div className="flex-1 text-right">
            ...
            {/* DEGREE NAME/TITLE */}
            <div className="mb-4">
              <span className="font-bold text-lg" style={{color: '#111c4e'}}>DEGREE NAME/TITLE: </span>
              <span className="text-lg" style={{color: '#111c4e'}}>{formData.degreeName || 'Not provided'}</span>
            </div>
            ...
            <div className="mb-4">
              ...
              <span className="text-lg" style={{color: '#111c4e'}}>Diploma/T.O.R (Uploaded)</span>
            </div>
          ...
          <div className="flex justify-center gap-6">
            <button
              ...
              onClick={() => navigate('/graduate-student-info', { state: { formData, requesterData } })}
            >
              BACK
            </button>
            <button
...
export default GraduateSummaryPage
