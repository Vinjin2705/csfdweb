...
function CrossDressingFormPage() {
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <section className="px-12 py-12">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Row: EMAIL ADDRESS, CONTACT NUMBER */}
          ...
          <div className="flex justify-center gap-4">
            <button
              ...
              onClick={() => navigate('/cross-dressing-info', { state: { formData } })}
            >
              BACK
            </button>
            <button
            ...
            <button
              ...
              onClick={() => {
                if (validateForm()) {
                  navigate('/cross-dressing-summary', { state: { formData } })
                }
              }}
            >
              PROCEED
...
export default CrossDressingFormPage
