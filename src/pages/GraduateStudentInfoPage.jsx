...
function GraduateStudentInfoPage() {
  ...
  const validateForm = () => {
    ...
    if (!formData.degreeName.trim()) newErrors.degreeName = 'Degree name/title is required'
          ...
          <div className="space-y-6">
            ...
            <div>
              <label className="block text-sm font-semibold mb-2" style={{color: '#111c4e'}}>
                YEAR GRADUATE<span className="text-red-500">*</span>
              </label>
              <input
                type="text"
                placeholder="Enter your year graduated"
                className={`w-full px-4 py-3 border-2 rounded-lg focus:outline-none focus:ring-2 ${errors.yearGraduated ? 'border-red-500' : ''}`}
                style={{borderColor: errors.yearGraduated ? '#dc2626' : '#111c4e'}}
                value={formData.yearGraduated}
                onChange={(e) => handleInputChange('yearGraduated', e.target.value)}
              />
              {errors.yearGraduated && <p className="text-red-500 text-sm mt-1">{errors.yearGraduated}</p>}
            </div>
            ...
            <div>
              <label className="block text-sm font-semibold mb-2" style={{color: '#111c4e'}}>
                DEGREE NAME/TITLE<span className="text-red-500">*</span>
              </label>
              <input
                type="text"
                placeholder="Enter your full degree name/title"
                className={`w-full px-4 py-3 border-2 rounded-lg focus:outline-none focus:ring-2 ${errors.degreeName ? 'border-red-500' : ''}`}
                style={{borderColor: errors.degreeName ? '#dc2626' : '#111c4e'}}
                value={formData.degreeName}
                onChange={(e) => handleInputChange('degreeName', e.target.value)}
              />
              {errors.degreeName && <p className="text-red-500 text-sm mt-1">{errors.degreeName}</p>}
            </div>
            ...
            <div className="mt-8">
              ...
              <p className="text-sm text-gray-600 mb-4">
                *Please upload a complete and clear copy of either your Diploma or Transcript of Records (T.O.R).
              </p>
...
export default GraduateStudentInfoPage
