...
function ComplaintInfoPage() {
  ...
  const steps = [
    {
      title: 'Step 1',
      description: 'Accomplish this Complaint Form.'
    },
    {
      title: 'Step 2',
      description: 'Wait for the validation of your complaint. Once validated, an email will be sent through your email for initial dialogue.'
    },
    {
      title: 'Step 3',
      description: 'Proceed to the CSFD Office with you official complaint letter.'
    },
    {
      title: 'Step 4',
      description: 'Wait for case hearing, details will be sent through formal invitation in email.'
    }
  ]
      ...
      <section className="px-12 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl font-black mb-2" style={{color: '#3d3d3d', fontFamily: 'Metropolis, sans-serif', fontWeight: '900'}}>COMPLAINT</h1>
          ...
          <div className="flex justify-center gap-6 mt-12">
            ...
            <button
              ...
              onClick={() => navigate('/complaint-form', { state: { formData: savedData } })}
            >
              PROCEED
            </button>
          </div>
...
export default ComplaintInfoPage
