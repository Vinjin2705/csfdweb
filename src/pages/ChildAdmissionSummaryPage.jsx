...
function ChildAdmissionSummaryPage() {
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <span style={{color: '#111c4e'}}>{getFullName(studentData)}</span>
                </div>
                <div>
                  <span className="font-bold" style={{color: '#111c4e'}}>SEX: </span>
                  <span style={{color: '#111c4e'}}>{studentData.sex || 'Not provided'}</span>
                </div>
              </div>
              ...
              <div>
                ...
                <span style={{color: '#111c4e'}}>{studentData.studentNumber || 'Not provided'}</span>
              </div>

              {/* COLLEGE/INSTITUTE */}
              <div>
                <span className="font-bold" style={{color: '#111c4e'}}>COLLEGE/INSTITUTE: </span>
                <span style={{color: '#111c4e'}}>{studentData.college || 'Not provided'}</span>
              </div>

              {/* YEAR/GRADE LEVEL */}
              <div>
                <span className="font-bold" style={{color: '#111c4e'}}>YEAR/GRADE LEVEL: </span>
                <span style={{color: '#111c4e'}}>{studentData.yearLevel || 'Not provided'}</span>
              </div>

              {/* EMAIL ADDRESS */}
              <div>
                <span className="font-bold" style={{color: '#111c4e'}}>EMAIL ADDRESS: </span>
                <span style={{color: '#111c4e'}}>{studentData.email || 'Not provided'}</span>
              </div>
          ...
          <div className="border-4 rounded-2xl p-6 mb-8" style={{borderColor: '#111c4e', backgroundColor: '#f9f9f9'}}>
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-start">
                <div>
                  <span className="font-bold" style={{color: '#111c4e'}}>NAME: </span>
                  <span style={{color: '#111c4e'}}>{getFullName(childData)}</span>
                </div>
                <div>
                  <span className="font-bold" style={{color: '#111c4e'}}>SEX: </span>
                  <span style={{color: '#111c4e'}}>{childData.sex || 'Not provided'}</span>
                </div>
              </div>

              {/* AGE */}
              <div>
                <span className="font-bold" style={{color: '#111c4e'}}>AGE: </span>
                <span style={{color: '#111c4e'}}>{childData.age || 'Not provided'}</span>
              </div>
          ...
          <div className="flex justify-center gap-4">
            <button
              ...
              onClick={() => navigate('/child-information', { state: { studentData, childData } })}
            >
              BACK
            </button>
            <button
...
export default ChildAdmissionSummaryPage
