...
function WorkingStudentSummaryPage() {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="border-4 rounded-2xl p-6 mb-8" style={{borderColor: '#111c4e', backgroundColor: '#f9f9f9'}}>
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <span style={{color: '#111c4e'}}>{formData.jobTitle || 'Not provided'}</span>
              </div>
              ...
              <div>
                ...
                <div className="ml-4 mt-1 space-y-1">
                  ...
                  <p style={{color: '#111c4e'}}>{formData.employmentFile ? `✓ ${formData.employmentFile.name}` : '<<requirements>>'}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-center gap-4">
            <button
              ...
              onClick={() => navigate('/working-student-form', { state: { formData } })}
            >
              BACK
            </button>
            <button
...
export default WorkingStudentSummaryPage
